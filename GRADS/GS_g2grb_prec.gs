...
filetmp=file'.tmp'
fileinv=file'.inv'
* GADDIR=/stornext/home/modoper/bin/grads-2.0.a9.oga/Resources/SupportData
*template0='$GADDIR/template.grb2'
template0='template.grb2'
...
lon1=subwrd(line,8)
dlon=(lon1-lon0) / (nx-1)
*DSM> say 'dlon=' dlon ' nx = 'nx' lon0 = ' lon0
...
lat1=subwrd(line,8)
dlat=(lat1-lat0) / (ny-1)
*DSM> say 'dlat=' dlat ' ny = 'ny' lat0 = ' lat0
...
'! ' wgrib2 ' ' template0 ' -d 1 -lola ' lon0 ':' nx ':' dlon ' ' lat0 ':' ny ':' dlat ' ' template ' grib 1>/dev/null'
...
*DSM> say 'opening fwrite ' filetmp
'set gxout fwrite'
*DSM> say 'going to display ' var
